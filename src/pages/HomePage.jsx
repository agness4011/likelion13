...
import ideathonImg from "../assets/images/Homeimages/Rectangle 240653310.jpg";
import bgImg from "../assets/images/Homeimages/Union.svg";
import groupImg from "../assets/images/Homeimages/Group 1707481940.jpg";
    ...
    <>
      ...
      <MainContainer>
        ...
        <ImageSection>
          ...
          { <OneImage src={ideathonImg} alt="Ideathon" /> }
        </ImageSection>
          { <TwoImage src={groupImg} alt="group" /> }
        {<FeedbackCards />}
      </MainContainer>
    </>
  );
